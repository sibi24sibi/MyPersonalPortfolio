    ...
    <>
      ...
      >
        ...
        <div className="INTRO pl-32 text-[70px]    leading-[80px] font-semibold max-sm:text-[40px] max-sm:leading-[70px] max-sm:font-semibold">
            ...
            <span className="bg-clip-text  text-transparent bg-gradient-to-r  from-blue-600 to-cyan-600 dark:from-cyan-500 dark:to-slate-200  md:text-base text-xs whitespace-nowrap ">
