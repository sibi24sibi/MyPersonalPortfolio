    ...
    <>
      <section className="NAVBAR sticky top-0 backdrop-blur-[5px] z-10 pt-5  translate-x-[20px] min-w-full mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px] ">
        <div className="flex justify-between capitalize md:ml-9 sm:ml-2">
          <div className="LOGO ">
            <p
              className="text-2xl flex flex-nowrap bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent dark:text-cyan-500 max-sm:text-2xl "
            >
              SIBI CHAKRABORTHY.V
            </p>
          </div>
          <div className="NAVLINKS min-w-full pr-64 text-[20px] translate-x-[-160px]  max-sm:hidden flex justify-end gap-12 text-[#00040f] dark:text-[#e1e1e1] ">
