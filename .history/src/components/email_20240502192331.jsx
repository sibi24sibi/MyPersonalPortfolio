        ...
        <div className="grid  grid-cols-2 gap-4 flex justify-center">
          ...
          <div>
            ...
            <input
              ...
              id="email"
              name="user_email"
              className="px-3 py-2 placeholder-gray-400 text-gray-600 relative dark:bg-slate-300 rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"
            />
          </div>
        </div>
        <textarea
          placeholder="Message"
          name="message"
          className="px-3 py-2 placeholder-gray-400 text-gray-600 relative dark:bg-slate-300 bg-black rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring h-40 w-full mt-4"
        ></textarea>
        <button
          type="submit"
