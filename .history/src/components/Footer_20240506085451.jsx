      ...
      <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
        ...
        <li>
          ...
          >
            ...
            <a href="https://iconscout.com/icons/developer-tool" class="text-underline font-size-sm" target="_blank">Githuub</a> by <a href="https://iconscout.com/contributors/unicons" class="text-underline font-size-sm">Unicons Font</a> on <a href="https://iconscout.com" class="text-underline font-size-sm">IconScout</a>
          </a>
        </li>
      </ul>
    </div>
