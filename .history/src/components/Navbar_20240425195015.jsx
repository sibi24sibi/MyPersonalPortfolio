  ...
  return (
    <>
      <section className="NAVBAR w-screen p-5 mx-20 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="WRAPPER flex  justify-between items-center  capitalize">
          <div className="LOGO">
            <a
              href="#"
          ...
          <div className="NAVLINKS flex justify-end  max-sm:hidden flex gap-12 text-[#00040f] dark:text-[#e1e1e1] ">
