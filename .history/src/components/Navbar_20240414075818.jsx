...
const Navbar = () => {
  ...
  useEffect(() => {
    if (theme === "dark") {
        ...
        document.documentElement.classList.remove(" border-2 rounded-full border-black");
        document.documentElement.classList.add("border-2 rounded-full border-white");
    } else {
        document.documentElement.classList.add("dark");
        document.documentElement.classList.remove("border-2 rounded-full border-white");
        document.documentElement.classList.add("border-2 rounded-full border-black");
    }
}, [theme]);
  ...
  return (
    <>
      <section className="NAVBAR fixed p-5 mx-20 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="NAVBAR flex  justify-between capitalize">
          ...
          <div className="NAVLINKS text-[20px] translate-x-[250px] max-sm:hidden flex gap-12 text-[#00040f] dark:text-[#e1e1e1] ">
