    ...
    <div   className="mb-20 max-w-6xl" id="contact">
      ...
      <form ref={form} onSubmit={sendEmail}>
        ...
        <textarea
          ...
          name="message"
          className="px-3 py-3 my-3 placeholder-gray-400 text-gray-600 relative dark:bg-zinc-900 bg-zinc-200 rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring h-40 w-full "
        ></textarea>
        <button
          type="submit"
