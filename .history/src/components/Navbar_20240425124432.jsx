...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR max-h-96 p-5 mx-5 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="NAVBAR WRAPPER mt-12 flex justify-between max-sm:flex-col gap-5 capitalize">
          <div className="LOGO">
            <a
              href="#"
