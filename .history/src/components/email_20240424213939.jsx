        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              id="name"
              name="user_name"
              className="px-0 py-2 placeholder-gray-400 text-gray-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full mx-5"
            />
          </div>
          <div>
