...
<Project_prop
  ...
  />
  <div className="card flex bg-sky-200 dark:bg-blue-900 rounded-lg shadow-lg  transform transition-transform hover:-translate-y-4" >  

        <SiGithub className="h-20 w-20 text-slate-800 dark:text-slate-300 text-xl max-sm:text-lg m-5 text-center" />
        
        
        <h3 
        className="font-bold h-20 text-slate-800 dark:text-slate-300 text-xl max-sm:text-lg m-5 text-center "
        >
