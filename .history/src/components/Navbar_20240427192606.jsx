...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR  p-5 translate-x-[20px] min-w-full mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px]">
        <div className="flex  justify-between capitalize">
          ...
          <div className="NAVLINKS min-w-full  text-[20px] translate-x-[-180px]  max-sm:hidden flex justify-end gap-12 text-[#00040f] dark:text-[#e1e1e1] ">
