  ...
  return (
    <footer className='w-screen h-fit dark:bg-neutral-800 bg-slate-300 dark: p-5'>
      <div className="flex justify-between ">
        ...
        <h3 className='p-12 bg-blue-800 rounded-full text-lg'> <SiGithub /></h3>
        <h3 className='p-12 bg-blue-800 rounded-full text-lg'> <SiGmail /></h3>
        <h3 className='p-12 bg-blue-800 rounded-full text-lg'> <SiLinkedin /></h3>
        </div>
      </div>
    </footer>
  );
