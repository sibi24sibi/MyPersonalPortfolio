  ...
  return (
    <>
      ...
      <div className="card bg-slate-300 dark:bg-zinc-900 rounded-lg shadow-lg  ">
        <h3 
        className="title capitalize font-bold  text-slate-800 dark:text-slate-300 text-xl max-sm:text-lg m-5 text-center"
        >
          {props.title}
        </h3>
            <div className="bar relative bottom-80  h-1 w-40 dark:bg-gray-800  m-auto"></div>
