  ...
  return (
    <>
      <div className="card bg-sky-50 dark:bg-blue-950 rounded-lg shadow-lg   ">
        ...
        <div className=" flex absolute  bottom-12 mx-10">
          ...
          <a className=" " href={props.github_link}>
            <button className="text-sm font-medium text-lime-300 mx-1 bg-transparent border border-lime-600 py-3 px-5 rounded-xl ">
              Code
            </button>
          </a>
        </div>
