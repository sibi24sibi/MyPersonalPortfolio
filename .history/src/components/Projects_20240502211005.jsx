...
<Project_prop
  ...
  <Project_prop
            ...
            github_link=""
  />
  <div className="card flex bg-slate-300 dark:bg-zinc-900 rounded-lg shadow-lg items-center justify-center ">
        <h3 
        className=" title capitalize font-bold h-20 text-slate-200 dark:text-slate-300 text-xl max-sm:text-lg m-5 text-center "
        >
