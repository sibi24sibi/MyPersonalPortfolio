    ...
    <div className="px-80 pb-20">
      ...
      <form ref={form} onSubmit={sendEmail}>
        ...
        <textarea
          placeholder="Message"
          name="message"
          className="px-3 py-2 placeholder-gray-400 text-gray-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-600 mt-4"
        ></textarea>
        <button
          type="submit"
