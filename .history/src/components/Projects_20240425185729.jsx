...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      className="EXPERIENCE max-w-4xl  p-5 mx-20 min-h-screen font-['Poppins']  max-sm:p-2 max-sm:mx-5"
    >
      <div className="WRAPPER mt-1 flex justify-center" data-aos="fade-down">
