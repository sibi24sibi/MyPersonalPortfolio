...
const Project_prop = (props) => {
  return (
    <>
      ...
      <div className="card  dark:bg-zinc-900 rounded-lg shadow-lg  ">
        <h3 
        className="title capitalize  text-slate-800 dark:text-slate-300 text-xl max-sm:text-lg m-5 text-center"
        >
          {props.title}
        </h3>
            <div className="bar  h-1 w-40 dark:bg-gray-800 bg-slate-300 m-auto"></div>
        <p className="dark:text-slate-500 mt-5 text-lg px-5">
          {props.para}
        </p>
      </div>
