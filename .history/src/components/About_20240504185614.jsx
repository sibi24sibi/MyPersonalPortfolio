  ...
  return (
    <>
      ...
      >
        ...
        <div className="INTRO text-[70px]  leading-[80px] font-semibold max-sm:text-[40px] max-sm:leading-[70px] max-sm:font-semibold w-96 ">
            ...
            <span className="bg-clip-text pt-20 text-transparent bg-gradient-to-r mx-2 from-blue-600 to-cyan-600 dark:from-cyan-500 dark:to-slate-200 text-base">
