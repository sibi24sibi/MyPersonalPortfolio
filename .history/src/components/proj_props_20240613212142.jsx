      ...
      <Tilt options={defaultOptions} style={{ height: 320, width: 250 }}>
        <div className="card-projects-dark mx-auto  dark:bg-gray-900 bg-slate-50 ">
          ...
          <div className="flex justify-center">
            <a
              className=" inline-flex items-center absolute bottom-0 m-5   rounded border inset-x-1/4 border-indigo-600 px-8 py-3 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
              href={github_link}
            >
