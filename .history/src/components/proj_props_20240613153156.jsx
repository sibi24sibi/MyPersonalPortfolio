    ...
    <section id="projects">
      <Tilt options={defaultOptions} style={{ height: 300, width: 300 }}>
        <div className="card-projects">
          ...
          <a
            className="inline-flex items-center gap-2 text-left rounded border absolute bottom-0 mb-10 inset-x-1/4 border-indigo-600 px-8 py-3 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
            href={github_link}
          >
