  ...
  return (
    <>
      <section className="NAVBAR sticky top-0 backdrop-blur-[5px] z-10 pt-5  translate-x-[20px] min-w-full mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px] ">
        <div className="flex  justify-between capitalize ml-9">
          <div className="LOGO ">
            <a
              href="#"
          ...
          <button onClick={() => setNav(!nav)}>
            <CgMenuRightAlt className="hidden max-sm:block m-5 translate-y[15px]  absolute top-0  right-10 md:transform-none text-[#00040f] dark:text-[#e1e1e1] text-[32px]" />
          </button>
