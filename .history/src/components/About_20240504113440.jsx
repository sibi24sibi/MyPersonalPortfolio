...
const About = () => {
  return (
    <>
      ...
      >
        <div className="WRAPPER mt-12 flex justify-between max-sm:flex-col gap-72">
        <div className="INTRO text-[70px] sm:mb-40 leading-[80px] font-semibold max-sm:text-[40px] max-sm:leading-[70px] max-sm:font-semibold">
