...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR max-w-fit p-5 mx-5 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className=" flex justify-between max-sm:flex-col capitalize">
          <div className="LOGO">
            <a
              href="#"
          ...
          <div className="NAVLINKS text-[20px] translate-x-[250px] max-sm:hidden flex grid justify-items-end gap-12 text-[#00040f] dark:text-[#e1e1e1] ">
