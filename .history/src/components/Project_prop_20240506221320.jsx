...
const Project_prop = (props) => {
  return (
    <>
      ...
      <div className="card bg-sky-50 dark:bg-blue-950 rounded-lg shadow-lg min-w-fit  ">
        <h3 
...
<a
  class="inline-block rounded border border-indigo-600  px-8 py-3 text-sm font-medium text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
