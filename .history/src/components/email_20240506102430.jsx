...
const MyEmailLayout = () => {
  ...
  <div class="overflow-hidden">
    <textarea
      id="OrderNotes"
      class="w-full resize-none border-x-0 border-t-0 border-gray-200 px-0 align-top sm:text-sm dark:border-gray-700 dark:bg-gray-800 dark:text-white"
      rows="4"
    ...
    <div class="flex items-center justify-end gap-2 py-3">
      <button
        type="button"
        class="rounded bg-gray-200 px-3 py-1.5 text-sm font-medium text-gray-700 hover:text-gray-600 bg-transparent dark:text-gray-200 dark:hover:text-gray-100"
      >
        Clear
      </button>
