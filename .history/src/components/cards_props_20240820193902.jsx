  ...
  return (
    <>
      <div className="card bg-sky-50 dark:bg-blue-950 rounded-lg shadow-lg w-fit  ">
        ...
        <a
          className="inline-flex items-center gap-2  rounded border absolute bottom-5 border-indigo-600 px-8 py-3 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
          href={props.github_link}
        >
          <button className="text-sm font-medium">View</button>
        </a>
        <a href="inline-flex items-center gap-2  rounded border  mb-10 inset-x-1/4 border-indigo-600 px-8 py-3 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500">
          <button className="text-sm font-medium">View</button>
        </a>
      </div>
    </>
