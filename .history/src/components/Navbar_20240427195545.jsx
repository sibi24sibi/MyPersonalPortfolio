...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR sticky top-0 backdrop-blur-[10px] rounded-b-lg  mt-5 p-5 translate-x-[20px] min-w-full mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px] ">
