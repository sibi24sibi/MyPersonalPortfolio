...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR max-h-scrren p-5 mx-5 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="NAVBAR flex justify-between max-sm:flex-col capitalize">
          <div className="LOGO">
            <a
              href="#"
