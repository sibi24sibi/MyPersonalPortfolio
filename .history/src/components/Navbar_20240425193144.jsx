...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR w-screen p-5 mx-20 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="WRAPPER flex  justify-between capitalize">
          ...
          <div className="NAVLINKS w-screen text-[20px] translate-x-[250px] max-sm:hidden flex gap-12 text-[#00040f] dark:text-[#e1e1e1] ">
