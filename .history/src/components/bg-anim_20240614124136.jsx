      ...
      <div className="mx-auto  px-4 pb-8  sm:px-6 lg:px-8 ">
        <div className=" border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between  ">
          <ul className="flex flex-wrap justify-center gap-4 text-xs lg:justify-end">
            <li>
              <p className="text-gray-700 dark:text-slate-300 transition hover:opacity-75 text-lg">
                {" "}
                Connect With Me{" "}
              </p>
            </li>
          ...
          <ul className="mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end">
            <li>
              <a
                href="https://www.linkedin.com/in/sibi-chakraborthy-v/"
                rel="noreferrer"
                target="_blank"
            ...
            <li>
              <a
                href="https://github.com/sibi24sibi"
                rel="noreferrer"
                target="_blank"
                className=" transition hover:opacity-75"
              >
            ...
            <li>
              <a
                href="mailto:sibi24sibi.2@gmail.com"
                rel="noreferrer"
                target="_blank"
                className=" transition hover:opacity-75"
              >
