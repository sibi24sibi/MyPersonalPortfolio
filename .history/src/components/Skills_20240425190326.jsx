...
const Skills = () => {
  ...
  return (
    <>
      <section className="EXPERIENCE p-5 mx-20 mb-10 max-w-4xl  font-['Poppins']  max-sm:p-2 max-sm:mx-5">
        <h1 className="text-[#00040f] dark:text-slate-300 font-extrabold text-5xl text-center max-sm:text-4xl ">
          SKILLS
        </h1>
        <div
          className="IMG grid place-content-start p-5 grid-cols-3 gap-4 max-sm:p-2 mt-10"
