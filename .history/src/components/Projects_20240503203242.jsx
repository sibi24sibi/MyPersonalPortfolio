...
<section
    ...
    >
<h1 className="text-[#00040f] dark:text-slate-300 text-center mt-10 font-extrabold text-5xl mb-24  max-sm:text-4xl  ">
          Projects
</h1>
...
<Project_prop
  ...
  />
  <div className="card flex bg-blue-200 dark:bg-sky-900 rounded-lg shadow-lg items-center justify-center ">
        <h3 
