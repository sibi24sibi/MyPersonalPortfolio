  ...
  return (
    <>
      <div className="card bg-sky-50 dark:bg-blue-950 rounded-lg shadow-lg w-fit  ">
        ...
        <div className="bar h-1 min-w-fit dark:bg-gray-400  bg-slate-600  mx-5"></div>
        ...
        <a className="  " href={props.github_link}>
          <button className="text-sm font-medium text-lime-300  m-2 bg-transparent border border-lime-600 py-3 px-5 rounded-xl ">
            View
          </button>

          <button className="text-sm font-medium text-lime-300 bg-transparent border border-lime-600 py-3 px-5 rounded-xl ">
            View
          </button>
        </a>
      </div>
