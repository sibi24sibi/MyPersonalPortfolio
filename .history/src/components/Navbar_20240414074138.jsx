...
const Navbar = () => {
  ...
  useEffect(() => {
    if (theme === "dark") {
      ...
      document.documentElement.classList.remove("border-white");
      document.documentElement.classList.add("border-black");
    } else {
      document.documentElement.classList.add("dark");
      
      document.documentElement.classList.remove("border-black");
      document.documentElement.classList.add("border-white");
    }
  }, [theme]);
