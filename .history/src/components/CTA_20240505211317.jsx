...
function CTA() {
  ...
  return (
    <div id="resume" className="pt-36 max-w-6xl resume relative w-full flex justify-center ">
      ...
      >
        <span className="btn__text btn__starter-text dark:text-gray-950 dark:bg-gray-100 text-gray-100 bg-gray-950">Download</span>
      </button>
      {isCompleted && (
        <span className="btn__text btn__ender-text dark:text-gray-950 dark:bg-gray-100 text-gray-100 bg-gray-950">Open File</span>
      )}
