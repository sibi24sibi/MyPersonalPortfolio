  ...
  return (
    <div className="pt-36 relative w-full flex justify-center ">
      ...
      <div className="pt-14 pb-40">
        ...
        mt-6 px-8 py-3 dark:text-[#e1e1e1] border-2 rounded-full border-[#808080]  inline-flex items-center bg-bg hover:bg-fun-pink hover:border-fun-pink transition-colors"
        >
