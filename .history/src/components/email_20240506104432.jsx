...
const MyEmailLayout = () => {
  ...
  <div class="overflow-hidden">
    <textarea
      id="Message"
      class="w-full px-2 p-2  resize-none border-b-4 dark:border-slate-700  border-gray-300 border-x-0 border-t-0  px-0 align-top sm:text-sm  bg-transparent dark:text-white"
      rows="4"
