...
const Navbar = () => {
  ...
  return (
    <section className="NAVBAR sticky top-3 backdrop-blur-[5px] z-10 pt-10 translate-x-[25px] min-w-full mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px]">
