    ...
    <div   className="mb-20 max-w-6xl" id="contact">
      ...
      <form ref={form} onSubmit={sendEmail}>
            ...
            <label
              ...
              >
                <input
                  ...
                  placeholder="Email"
                  name="user_email"
                  class="peer h-8 w-full border-none bg-zinc-100 p-0 placeholder-transparent focus:border-transparent focus:outline-none focus:ring-0 sm:text-sm dark:text-white"
                />
        ...
        <textarea
          ...
          name="message"
          className="px-3 py-3 my-3 placeholder-gray-400 text-gray-600 relative dark:bg-zinc-900 bg-zinc-100 rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring h-40 w-full "
        ></textarea>
        <button
          type="submit"
