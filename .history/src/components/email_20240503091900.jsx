        ...
        <div className="grid  grid-cols-2 gap-4 flex justify-center">
          <div>
            ...
            <input
              ...
              id="name"
              name="user_name"
              className="px-3 py-2 placeholder-gray-400 text-gray-600 relative dark:bg-slate-300 bg-slate-300 rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring  w-full"
            />
          </div>
          <div>
