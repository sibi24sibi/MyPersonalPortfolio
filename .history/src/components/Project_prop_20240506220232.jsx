      ...
      <div className="card bg-sky-50 dark:bg-blue-950 rounded-lg shadow-lg aspect-w-16 aspect-h-9  ">
        ...
        <div className="div m-10 ">
          ...
          >
            ...
            <span
              class="block border border-red-600 bg-blue-600 px-6 py-3 transition-transform active:border-red-500 active:bg-red-500 group-hover:-translate-x-1 group-hover:-translate-y-1"
            >
              Download
            </span>
          </a>
