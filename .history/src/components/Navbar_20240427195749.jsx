...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR sticky top-0 backdrop-blur-[10px] border-8 border-sky-500 rounded-full mt-5 p-5 translate-x-[20px] min-w-full mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px] ">
        <div className="flex  justify-between capitalize">
          ...
          <button onClick={() => setNav(!nav)}>
            <CgMenuRightAlt className="hidden max-sm:block translate-x-[300px] md:transform-none text-[#00040f] dark:text-[#e1e1e1] text-[32px]" />
          </button>
