      ...
      <section className="NAVBAR p-5 mx-20 mt-5 font-['Poppins'] max-sm:p-2 max-sm:mx-5 max-sm:max-h-[48px]">
        <div className="NAVBAR flex  justify-between capitalize">
          <div className="LOGO">
            <a
              href="#"
              className={`text-3xl bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent ${
                theme === "dark" ? "dark:text-cyan-500" : "text-black"
              } max-sm:text-2xl`}
            >
              {"Portfolio"}
            </a>
          </div>
          <div className={`NAVLINKS text-[20px] translate-x-[250px] max-sm:hidden flex gap-12 ${
