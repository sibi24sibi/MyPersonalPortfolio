...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR sticky top-0 backdrop-blur-[5px] z-10  mt-2 pt-5  translate-x-[20px] min-w-full mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px] ">
      ...
      <style>{`
        .NAVBAR {
          /* Your internal CSS styles here */
          background-color: #fff; /* Example background color */
          border: 1px solid #ccc; /* Example border */
        }

        .LOGO {
          /* Example styles for LOGO class */
          margin-left: 20px; /* Adjust as needed */
        }

        /* Add more internal styles as needed */
      `}</style>
    </>
  );
};
