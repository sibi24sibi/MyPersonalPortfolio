...
<Project_prop
  ...
  />
  <div className="card flex bg-sky-200 dark:bg-blue-950 rounded-lg shadow-lg items-center justify-center transform transition-transform hover:-translate-y-4"
