  ...
  return (
    <div   className="mb-20 max-w-6xl" id="contact">
      ...
      <form ref={form} onSubmit={sendEmail}>
        ...
        <label htmlFor="message" className="dark:text-[#e1e1e1]"></label>
        <textarea
          placeholder="Enter you message Here"
          name="message"
          className="px-3 py-2 placeholder-gray-400 text-gray-600 relative dark:bg-zinc-900 bg-stone-300 rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring h-40 w-full "
        ></textarea>
        <button
          type="submit"
