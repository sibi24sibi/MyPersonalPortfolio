...
<Project_prop
  ...
  />
  <div className="card flex bg-blue-200 dark:bg-sky-900 rounded-lg shadow-lg items-center justify-center transform transition-transform hover:-translate-y-4"
