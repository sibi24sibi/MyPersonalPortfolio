...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR p-5 max-w-6xl mx-20 mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px]">
        <div className="WRAPPER flex  justify-between capitalize">
          <div className="LOGO translate-x-[-125px]">
            <a
              href="#"
          ...
          <button onClick={() => setNav(!nav)}>
            <CgMenuRightAlt className="hidden max-sm:block translate-x-[120px] text-[#00040f] dark:text-[#e1e1e1] text-[32px]" />
          </button>
        </div>
        {nav && <Menu />}
      </section>
