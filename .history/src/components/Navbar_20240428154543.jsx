...
const Navbar = () => {
  ...
  return (
    <>
      <section className="NAVBAR sticky top-3 backdrop-blur-[5px] z-10  mt-2 pt-5  translate-x-[20px] min-w-full mt-5 font-['Poppins']  max-sm:p-2 max-sm:mx-1 max-sm:max-h-[48px] ">
