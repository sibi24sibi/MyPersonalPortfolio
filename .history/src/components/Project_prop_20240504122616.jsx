...
const Project_prop = (props) => {
  return (
    <>
      ...
      <div className="card bg-blue-100 dark:bg-sky-950 rounded-lg shadow-lg aspect-w-16 aspect-h-9 transform transition-transform hover:-translate-y-4 hover:translate-x-8">
        <h3 
