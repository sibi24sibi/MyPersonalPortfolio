...
const Skills = () => {
  ...
  return (
    <>
      <section className="EXPERIENCE p-5  mb-10 max-w-6xl  font-['Poppins']  max-sm:p-2 max-sm:mx-5">
        <div>
        ...
        <div
          className=" grid place-content-start  grid-cols-3 gap-4 max-sm:p-2 mt-10"
