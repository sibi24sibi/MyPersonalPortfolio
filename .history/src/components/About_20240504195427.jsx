    ...
    <>
      ...
      >
        ...
        <div className="INTRO text-[70px] md:w-2/6 text-center md:text-left leading-[80px] font-semibold max-sm:text-[40px] max-sm:leading-[70px] max-sm:font-semibold">
            ...
            <p className="ABOUT h-[100px] text-xl max-sm:text-[15px] bg-clip-text text-transparent text-left bg-gradient-to-r  from-[#00040f] to-slate-500 dark:from-slate-500 dark:to-slate-200  mt-5 pl-1  max-sm:text-[20px] min-w-[400px]">
