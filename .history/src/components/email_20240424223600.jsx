...
const MyEmailLayout = () => {
  ...
  return (
    <div   className="  mb-20">
      <h1 className="text-2xl dark:text-[#e1e1e1] font-bold mb-4 text-center">SEND ME A EMAIL</h1>
      <div className="relative mx-20 flex justify-center">
      ...
      <form ref={form} onSubmit={sendEmail}>
        ...
        <textarea
          placeholder="Message"
          name="message"
          className="px-3 py-2 placeholder-gray-400 text-gray-600 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring h-40 w-full mt-4"
        ></textarea>
        <button
          type="submit"
