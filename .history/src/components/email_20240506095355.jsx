    ...
    <div   className="mb-20 max-w-6xl" id="contact">
      ...
      <form ref={form} onSubmit={sendEmail}>
        ...
        <textarea
          placeholder=""
          name="message"
          className="px-3 py-2 placeholder-gray-400 text-gray-600 relative dark:bg-slate-800 bg-stone-300 rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring h-40 w-full "
        ></textarea>
        <button
          type="submit"
