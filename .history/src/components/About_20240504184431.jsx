    ...
    <>
      ...
      >
        ...
        <div className="INTRO text-[70px]  leading-[80px] font-semibold max-sm:text-[40px] max-sm:leading-[70px] max-sm:font-semibold">
            ...
            <span className="bg-clip-text pt-10 text-transparent bg-gradient-to-r  from-blue-600 to-cyan-600 dark:from-cyan-500 dark:to-slate-200 text-base">
        ...
        <div className="div flex justify-center align-items sm:ml-44 ml-0 ">
