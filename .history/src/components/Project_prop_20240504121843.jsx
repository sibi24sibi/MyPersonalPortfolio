...
const Project_prop = (props) => {
  ...
  useEffect(() => {
    AOS.init();
  }, []); // Make sure it runs only once after component mounts
  ...
  return (
    <>
      ...
      <div className="card bg-blue-100 dark:bg-sky-950 rounded-lg shadow-lg aspect-w-16 aspect-h-9 transform transition-transform hover:-translate-y-4 group"
            data-aos="fade-right"
      >
        <h3 
