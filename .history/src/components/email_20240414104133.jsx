        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              id="name"
              name="name"
              className="px-3 py-2 placeholder-gray-400 text-gray-300 relative bg-white rounded text-sm border-0 shadow outline-none focus:outline-none focus:ring w-full"
            />
          </div>
          <div>
